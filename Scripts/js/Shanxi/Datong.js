...
function main(item) {
    try {
        ...
        // 获取频道代码参数，默认xwzh
        var channel = ku9.getQuery(item.url, "id") || 'xwzh';
        ...
        var apiUrl = "http://mapi.dtradio.com.cn/api/v1/channel.php?channel_id=" + channelId;
        
        // 设置请求头
        var headers = {
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36",
            "Accept": "application/json, text/plain, */*",
            "Referer": "http://mapi.dtradio.com.cn/",
            "Origin": "http://mapi.dtradio.com.cn"
        };
        ...
        if (!m3u8.startsWith('http://') && !m3u8.startsWith('https://')) {
            // 如果是相对路径，尝试添加基础URL
            if (m3u8.startsWith('/')) {
                m3u8 = 'http://mapi.dtradio.com.cn' + m3u8;
            } else {
                return JSON.stringify({
                    code: 500,
                    message: '播放地址格式错误',
...
// 使用说明示例：
// https://yourdomain.com/Shanxi_dtxl.js?id=xwzh
// https://yourdomain.com/Shanxi_dtxl.js?id=ggpd
// https://yourdomain.com/Shanxi_dtxl.js?id=mdsh